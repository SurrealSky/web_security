...
+ Arjun
	...
	- 主动扫描： ``arjun -u https://example.com/endpoint.php -oT arjun_output.txt -m GET,POST -w /home/temp/SecLists/Discovery/Web-Content/burp-parameter-names.txt -t 10 --rate-limit 10 --headers "User-Agent: Mozilla/5.0"``
+ ParamSpider
