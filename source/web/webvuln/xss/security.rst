...
简介
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
同源策略（Same Origin Policy，SOP）是 **浏览器** 的一种安全机制，用于防止不同源的网页脚本相互访问和操作，从而保护用户的数据安全。SOP规定，只有当两个网页具有相同的协议、域名和端口时，它们才能相互访问。
...
CORS
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
CORS是一个W3C标准，全称是"跨域资源共享"（Cross-origin resource sharing）。它是 **服务端** 通过控制响应头部来控制是否允许浏览器进行一些跨域请求。
